...
#include "itype.h"
#define REFERENTIABLE_SERIALIZE cereal::make_nvp("referentiable", cereal::virtual_base_class<Referentiable>(this))
...
// ? REFERENTIABLE ###################
class Referentiable : virtual IType {
   private:
   ...
   public:
	...
	ITYPE override { return "Referentiable"; };
