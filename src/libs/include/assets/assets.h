...
extern std::map<std::string, std::shared_ptr<File>> rpath_asset_ht;
extern std::map<uint, std::string> id_rpath_ht;
extern std::multimap<std::string, std::shared_ptr<File>> type_asset_ht;
